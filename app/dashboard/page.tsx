                ...
                {user?.profile.role === 'org_admin' && (
                    <div className="space-y-6">
                        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 text-center">
                            ...
                            <h3 className="text-2xl font-bold text-white mb-2">Organization Management</h3>
                            <p className="text-blue-200 mb-6">Organization admin features coming soon...</p>
                            <div className="inline-flex items-center px-4 py-2 bg-blue-500/20 text-blue-200 rounded-lg border border-blue-500/30">
                                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {user?.profile.role === 'technician' && (
                    <div className="space-y-6">
                        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 text-center">
                            ...
                            <h3 className="text-2xl font-bold text-white mb-2">Troubleshooting Tools</h3>
                            <p className="text-blue-200 mb-6">Technician features coming soon...</p>
                            <div className="inline-flex items-center px-4 py-2 bg-purple-500/20 text-purple-200 rounded-lg border border-purple-500/30">
                                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                Under Development
