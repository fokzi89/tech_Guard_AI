                    ...
                    <div className="space-y-8">
                        ...
                        <div className="glass-panel rounded-2xl p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <button
                                    onClick={() => setShowInviteModal(true)}
                                    className="group bg-gradient-to-br from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 rounded-xl p-6 text-left transition-all shadow-lg hover:shadow-2xl hover:scale-105 transform"
                                >
                                    <div className="flex items-center space-x-4">
                                        <div className="w-14 h-14 bg-white/20 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                                            <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div className="flex-1">
                                            <h4 className="text-xl font-bold text-white mb-1">Invite User</h4>
                                            <p className="text-indigo-100 text-sm">Add team member</p>
                                        </div>
                                        <svg className="w-6 h-6 text-white/50 group-hover:text-white group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                        </svg>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="glass-panel glass-panel-hover rounded-xl p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="gradient-text-muted text-sm font-medium">Active Sessions</p>
                            ...
                            <div className="glass-panel glass-panel-hover rounded-xl p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="gradient-text-muted text-sm font-medium">Resolved Today</p>
                                        <p className="text-4xl font-bold gradient-text mt-2">0</p>
                                    </div>
                                    <div className="w-12 h-12 bg-green-500/20 rounded-lg flex items-center justify-center">
                                        <svg className="w-6 h-6 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="glass-panel glass-panel-hover rounded-xl p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="gradient-text-muted text-sm font-medium">Total Sessions</p>
                                        <p className="text-4xl font-bold gradient-text mt-2">0</p>
                                    </div>
                                    <div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center">
                                        <svg className="w-6 h-6 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-blue-500/10 dark:bg-blue-500/20 backdrop-blur-lg rounded-2xl p-6 border border-blue-500/20 dark:border-blue-500/30">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold gradient-text mb-2">Safety First</h4>
                                        <p className="gradient-text-muted text-sm">
                            ...
                            <div className="bg-purple-500/10 dark:bg-purple-500/20 backdrop-blur-lg rounded-2xl p-6 border border-purple-500/20 dark:border-purple-500/30">
                                <div className="flex items-start">
                                    <svg className="w-6 h-6 text-purple-600 dark:text-purple-400 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <div>
                                        <h4 className="text-lg font-semibold gradient-text mb-2">Ready to Use</h4>
                                        <p className="gradient-text-muted text-sm">
                                            AI-powered troubleshooting with safety Guardian, photo verification, and real-time diagnostics are now available. Start a new session to get started!
                                        </p>
                                    </div>
                                </div>
                            </div>
